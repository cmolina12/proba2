...
# Ejemplo: variables del modelo
Datos <- data.frame(
  Precio = datos_vivienda$precio,
  Zona = datos_vivienda$Zona,
  Area = datos_vivienda$area,
  baños = datos_vivienda$baños,
  AreaGaraje = datos_vivienda$areaGaraje
)

pairs(Datos,
      pch = 19,
      col = "black",
      main = "Gráficos de dispersión por pares de variables")
